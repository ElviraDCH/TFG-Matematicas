...
#Estimacion de la funcion de supervivencia mediante el metodo actuarial
S <- c(0.679, 0.515, 0.312, 0.211, 0.158, 0.088, 0.070, 0.035, 0.018, 0.018,
       0.018, 0,0)

#Division de la duracion del estudio en intervalos de 50 dias 
t <- seq(0,600,50)
...
ggplot()+
  ...
  labs(x='Tiempo en dias', y='Probabilidad de supervivencia')+
  scale_colour_manual(' ',values = c('0' = '#BD263E','1' = 'black'),
                      labels = c( "Estimacion actuarial", "Observaciones censuradas"))+
